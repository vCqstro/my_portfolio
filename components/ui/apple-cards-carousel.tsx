              ...
              >
                <div className="flex flex-wrap mt-4">
                  {card.technologies.map((technology) => (
                    <div
                      key={technology.name}
                      className="bg-gray-100 text-lg dark:bg-neutral-800 px-2 py-1 rounded-md mr-2 mb-2 inline-flex items-center"
                    >
                      {technology.icon && <technology.icon className="mr-1" />}
                      {technology.name}
                    </div>
                  ))}
                </div>
